...
<div class="page-header" style="background:linear-gradient(160deg,var(--deep-earth) 0%,var(--forest-green) 100%);color:white;">
    <div class="container">
        ...
        <h1 class="page-title" style="color:white;">Create Tour Package</h1>
        <p class="page-subtitle" style="color:rgba(255,255,255,0.9);">Add a new travel offering for your agency</p>
    </div>
</div>
            ...
            <div style="display:grid;gap:1.5rem;">
                ...
                <div class="form-group">
                    ...
                    <select name="destination_id" class="form-input" required>
                        ...
                        <option value="{{ $destination->id }}" {{ old('destination_id', request('destination_id')) == $destination->id ? 'selected' : '' }}>
