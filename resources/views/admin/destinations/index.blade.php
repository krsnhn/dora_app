    ...
    <div class="container">
        <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:1rem;">
            <div>
                ...
                <p class="page-subtitle">Manage all platform destinations</p>
            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex;gap:.4rem;">
                                <form method="POST" action="{{ route('admin.destinations.review-request', $req) }}">
                                    @csrf @method('PATCH')
                    ...
                    <tr>
                        <td>
                            <div style="display:flex;align-items:center;gap:.75rem;">
                                ...
                                @else
                                <div style="width:44px;height:44px;border-radius:8px;background:var(--beige);display:flex;align-items:center;justify-content:center;">
                                    <svg width="18" height="18" fill="none" stroke="var(--earth)" stroke-width="1.5" viewBox="0 0 24 24"><path d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0zM15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                                </div>
                                @endif
                                <div>
                        ...
                        <td>
                            <div style="display:flex;gap:.4rem;flex-wrap:wrap;">
                                ...
                                <form method="POST" action="{{ route('admin.destinations.toggle-approval', $destination) }}">
                                    @csrf @method('PATCH')
                                ...
                                <form method="POST" action="{{ route('admin.destinations.destroy', $destination) }}" onsubmit="return confirm('Delete this destination?')">
                                    @csrf @method('DELETE')
