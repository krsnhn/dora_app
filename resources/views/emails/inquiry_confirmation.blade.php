...
<div class="container">
    <div class="card">
        ...
        <div class="body">
            <p style="color:#2C1810;font-size:1.05rem;margin-bottom:.5rem;">Hi <strong>{{ $inquiry->contact_name }}</strong>,</p>
            ...
            <div>
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value" style="color:#2C5F2D;font-weight:700;">PHP {{ number_format($package->price ?? 0, 2) }}</span>
                </div>
                <div class="detail-row">
                ...
                <div class="detail-row" style="border:none;">
                    ...
                    <span class="detail-value">{{ $package->agency->business_name ?? $package->agency->name ?? '-' }}</span>
                </div>
            </div>

            <div class="info-box">
                <p style="color:#1E4A6D;font-size:.9rem;font-weight:600;margin:0 0 .4rem;">What happens next?</p>
                <p style="color:#555;font-size:.88rem;line-height:1.6;margin:0;">The agency will review your inquiry and contact you at <strong>{{ $inquiry->contact_email }}</strong>. Response times typically range from a few hours to 1 business day.</p>
            </div>
        ...
        <div class="footer">
            <p>This confirmation was sent to <strong>{{ $inquiry->contact_email }}</strong></p>
            <p style="margin-top:.25rem;">Copyright {{ date('Y') }} DORA Digital Tourism Connector. All rights reserved.</p>
        </div>
    </div>
</div>
</body>
